...
local turretTint = {0.1, 1.0, 0.1, 1}
local tesla_turret_shift = -26

local function green_tesla_rising(inputs)
  return
  {
    layers =
    {
...
local function green_tesla_ready(inputs)
  return
  {
    layers =
    {
...
local function green_tesla_cooldown(inputs)
  return
  {
    layers =
    {
...
local function green_tesla_led()
  return
  {
    layers =
    {
...
local function green_tesla_glow()
...
local function green_tesla_base_visualisation()
  return
  {
    {
      animation =
...
turret.name = "tier-two-tesla-turret"
turret.minable = {
  mining_time = 0.5,
  result = "tier-two-tesla-turret"
}
turret.icon = nil
turret.icons = nil
turret.icons = {
...
turret.folded_animation = green_tesla_rising({})
turret.preparing_animation = green_tesla_rising({})
turret.prepared_animation = green_tesla_ready({})
turret.ending_attack_animation = green_tesla_cooldown({})
turret.folding_animation = green_tesla_rising({run_mode = "backward"})
turret.energy_glow_animation = green_tesla_glow()
turret.glow_light_intensity = 0.5
turret.resource_indicator_animation = green_tesla_led()

turret.graphics_set.base_visualisation = green_tesla_base_visualisation()

-- Tier 2 tesla turret: cooldown (fire rate) and beam damage are set on the
-- green-tesla-beam-start / green-tesla-beam-bounce / tier-two-tesla-chain
-- prototypes defined in green-tesla-beam.lua
