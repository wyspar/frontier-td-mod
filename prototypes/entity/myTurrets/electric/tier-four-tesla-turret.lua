...
local turretTint = {1.0, 0.1, 0.1, 1}
local tesla_turret_shift = -26

local function red_tesla_rising(inputs)
  return
  {
    layers =
    {
...
local function red_tesla_ready(inputs)
  return
  {
    layers =
    {
...
local function red_tesla_cooldown(inputs)
  return
  {
    layers =
    {
...
local function red_tesla_base_visualisation()
  return
  {
    {
      animation =
...
turret.folded_animation = red_tesla_rising({})
turret.preparing_animation = red_tesla_rising({})
turret.prepared_animation = red_tesla_ready({})
turret.ending_attack_animation = red_tesla_cooldown({})
turret.folding_animation = red_tesla_rising({run_mode = "backward"})
turret.energy_glow_animation = red_tesla_glow()
turret.glow_light_intensity = 0.5
turret.resource_indicator_animation = red_tesla_led()

turret.graphics_set.base_visualisation = red_tesla_base_visualisation()

-- Tier 4 tesla turret: cooldown (fire rate) and beam damage are set on the
-- red-tesla-beam-start / red-tesla-beam-bounce / tier-four-tesla-chain
-- prototypes defined in red-tesla-beam.lua
