...
local turretTint = {0.5, 0.5, 0.5, 1}
local tesla_turret_shift = -26

local function gray_tesla_rising(inputs)
  return
  {
    layers =
    {
...
local function gray_tesla_ready(inputs)
  return
  {
    layers =
    {
...
local function gray_tesla_cooldown(inputs)
  return
  {
    layers =
    {
...
local function gray_tesla_glow()
...
local function gray_tesla_base_visualisation()
  return
  {
    {
      animation =
...
turret.folded_animation = gray_tesla_rising({})
turret.preparing_animation = gray_tesla_rising({})
turret.prepared_animation = gray_tesla_ready({})
turret.ending_attack_animation = gray_tesla_cooldown({})
turret.folding_animation = gray_tesla_rising({run_mode = "backward"})
turret.energy_glow_animation = gray_tesla_glow()
turret.glow_light_intensity = 0.5
turret.resource_indicator_animation = gray_tesla_led()

turret.graphics_set.base_visualisation = gray_tesla_base_visualisation()

-- Tier 1 tesla turret: cooldown (fire rate) and beam damage are set on the
-- gray-tesla-beam-start / gray-tesla-beam-bounce / tier-one-tesla-chain
-- prototypes defined in gray-tesla-beam.lua
