...
turret.name = "tier-three-gun-turret"
turret.minable = {
  mining_time = 0.1,
  result = "tier-three-gun-turret"
}
...
turret.attacking_speed = 0.75 --animation?
...
turret.attack_parameters = {
  ...
  ammo_type = {
    action = {
      ...
      action_delivery = {
        type = "projectile",
        projectile = "bullet-projectile-tier-three",
        starting_speed = 1
      }
    }
  }
