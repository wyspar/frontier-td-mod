...
local blue_beam_blend_mode = "additive"
local blue_beam_flags = { "trilinear-filtering" }
local blue_beam_tint = {0.1, 0.3, 1.0}

local function blue_tesla_body_sprite(token)
  return
  {
    util.sprite_load("__space-age__/graphics/entity/beam/tesla-body-" .. token,
    {
      ...
      scale = 0.5,
      tint = blue_beam_tint,
      blend_mode = blue_beam_blend_mode
    }),
...
local function blue_tesla_chain_sprite(token)
  return
  {
...
local function blue_tesla_ground_lights()
  return
  {
    head =
    {
...
local function blue_tesla_beam_graphics()
  local graphics_set =
  {
  ...
  graphics_set.beam =
  {
    ...
    body =
    {
      {layers = blue_tesla_body_sprite('1')},
      {layers = blue_tesla_body_sprite('2')},
      {layers = blue_tesla_body_sprite('3')},
      {layers = blue_tesla_body_sprite('4')},
      {layers = blue_tesla_body_sprite('5')},
      {layers = blue_tesla_body_sprite('6')},
    }
  }

  graphics_set.ground = blue_tesla_ground_lights()

  return graphics_set
end

local function blue_tesla_chain_graphics()
  local graphics_set =
  {
    desired_segment_length = 1,
    randomize_animation_per_segment = true
  ...
  graphics_set.beam =
  {
    ...
    head = {layers = blue_tesla_chain_sprite('1')},
    tail = {layers = blue_tesla_chain_sprite('6')},

    body =
    {
      {layers = blue_tesla_chain_sprite('1')},
      {layers = blue_tesla_chain_sprite('2')},
      {layers = blue_tesla_chain_sprite('3')},
      {layers = blue_tesla_chain_sprite('4')},
      {layers = blue_tesla_chain_sprite('5')},
      {layers = blue_tesla_chain_sprite('6')},
    }
  }
...
local blueTeslaBeamStart =
{
  type = "beam",
  name = "blue-tesla-beam-start",
  flags = {"not-on-map"},
  hidden = true,
  width = 0.5,
  damage_interval = 20,
  ...
  graphics_set = blue_tesla_beam_graphics(),
  working_sound =
  {
...
local blueTeslaBeamBounce =
{
  type = "beam",
  name = "blue-tesla-beam-bounce",
  flags = {"not-on-map"},
  hidden = true,
  width = 0.5,
  damage_interval = 20,
  ...
  graphics_set = blue_tesla_chain_graphics(),
  working_sound =
  {
...
local blueTeslaChain =
{
  type = "chain-active-trigger",
  name = "tier-three-tesla-chain",
  max_jumps = 3,
