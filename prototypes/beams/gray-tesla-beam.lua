...
local gray_beam_blend_mode = "additive"
local gray_beam_flags = { "trilinear-filtering" }
local gray_beam_tint = {0.5, 0.5, 0.5}

local function gray_tesla_body_sprite(token)
  return
  {
    util.sprite_load("__space-age__/graphics/entity/beam/tesla-body-" .. token,
    {
      ...
      scale = 0.5,
      tint = gray_beam_tint,
      blend_mode = gray_beam_blend_mode
    }),
...
local function gray_tesla_chain_sprite(token)
  return
  {
...
local function gray_tesla_ground_lights()
  return
  {
    head =
    {
...
local function gray_tesla_beam_graphics()
  local graphics_set =
  {
  ...
  graphics_set.beam =
  {
    ...
    body =
    {
      {layers = gray_tesla_body_sprite('1')},
      {layers = gray_tesla_body_sprite('2')},
      {layers = gray_tesla_body_sprite('3')},
      {layers = gray_tesla_body_sprite('4')},
      {layers = gray_tesla_body_sprite('5')},
      {layers = gray_tesla_body_sprite('6')},
    }
  }

  graphics_set.ground = gray_tesla_ground_lights()

  return graphics_set
end

local function gray_tesla_chain_graphics()
  local graphics_set =
  {
    desired_segment_length = 1,
    randomize_animation_per_segment = true
  ...
  graphics_set.beam =
  {
    ...
    head = {layers = gray_tesla_chain_sprite('1')},
    tail = {layers = gray_tesla_chain_sprite('6')},

    body =
    {
      {layers = gray_tesla_chain_sprite('1')},
      {layers = gray_tesla_chain_sprite('2')},
      {layers = gray_tesla_chain_sprite('3')},
      {layers = gray_tesla_chain_sprite('4')},
      {layers = gray_tesla_chain_sprite('5')},
      {layers = gray_tesla_chain_sprite('6')},
    }
  }
...
local grayTeslaBeamStart =
{
  type = "beam",
  name = "gray-tesla-beam-start",
  flags = {"not-on-map"},
  hidden = true,
  width = 0.5,
  damage_interval = 20,
  ...
  graphics_set = gray_tesla_beam_graphics(),
  working_sound =
  {
...
local grayTeslaBeamBounce =
{
  type = "beam",
  name = "gray-tesla-beam-bounce",
  flags = {"not-on-map"},
  hidden = true,
  width = 0.5,
  damage_interval = 20,
  ...
  graphics_set = gray_tesla_chain_graphics(),
  working_sound =
  {
...
local grayTeslaChain =
{
  type = "chain-active-trigger",
  name = "tier-one-tesla-chain",
  max_jumps = 3,
