...
function make_laser_beam(sound)
    ...
    graphics_set =
    {
      beam =
      {
        head =
        {
          ...
          {
            {
              filename = "__frontier-td__/graphics/entity/laser-turret/green-laser-body.png",
        ...
        tail =
        {
          ...
          {
            {
              filename = "__frontier-td__/graphics/entity/laser-turret/green-laser-end.png",
              flags = beam_non_light_flags,
              width = 110,
              height = 62,
              frame_count = 8,
  ...
  if sound then
    ...
    result.name = "green-laser-beam"
  else
    result.name = "green-laser-beam-no-sound"
  end
  return result
end
