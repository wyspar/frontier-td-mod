...
local red_beam_blend_mode = "additive"
local red_beam_flags = { "trilinear-filtering" }
local red_beam_tint = {1.0, 0.1, 0.1}

local function red_tesla_body_sprite(token)
  return
  {
    util.sprite_load("__space-age__/graphics/entity/beam/tesla-body-" .. token,
    {
      ...
      scale = 0.5,
      tint = red_beam_tint,
      blend_mode = red_beam_blend_mode
    }),
...
local function red_tesla_chain_sprite(token)
  return
  {
...
local function red_tesla_ground_lights()
  return
  {
    head =
    {
...
local function red_tesla_beam_graphics()
  local graphics_set =
  {
  ...
  graphics_set.beam =
  {
    ...
    body =
    {
      {layers = red_tesla_body_sprite('1')},
      {layers = red_tesla_body_sprite('2')},
      {layers = red_tesla_body_sprite('3')},
      {layers = red_tesla_body_sprite('4')},
      {layers = red_tesla_body_sprite('5')},
      {layers = red_tesla_body_sprite('6')},
    }
  }

  graphics_set.ground = red_tesla_ground_lights()

  return graphics_set
end

local function red_tesla_chain_graphics()
  local graphics_set =
  {
    desired_segment_length = 1,
    randomize_animation_per_segment = true
  ...
  graphics_set.beam =
  {
    ...
    head = {layers = red_tesla_chain_sprite('1')},
    tail = {layers = red_tesla_chain_sprite('6')},

    body =
    {
      {layers = red_tesla_chain_sprite('1')},
      {layers = red_tesla_chain_sprite('2')},
      {layers = red_tesla_chain_sprite('3')},
      {layers = red_tesla_chain_sprite('4')},
      {layers = red_tesla_chain_sprite('5')},
      {layers = red_tesla_chain_sprite('6')},
    }
  }
...
local redTeslaBeamStart =
{
  type = "beam",
  name = "red-tesla-beam-start",
  flags = {"not-on-map"},
  hidden = true,
  width = 0.5,
  damage_interval = 20,
  ...
  graphics_set = red_tesla_beam_graphics(),
  working_sound =
  {
...
local redTeslaBeamBounce =
{
  type = "beam",
  name = "red-tesla-beam-bounce",
  flags = {"not-on-map"},
  hidden = true,
  width = 0.5,
  damage_interval = 20,
  ...
  graphics_set = red_tesla_chain_graphics(),
  working_sound =
  {
