...
local green_beam_blend_mode = "additive"
local green_beam_flags = { "trilinear-filtering" }
local green_beam_tint = {0.1, 1.0, 0.1}

local function green_tesla_body_sprite(token)
  return
  {
    util.sprite_load("__space-age__/graphics/entity/beam/tesla-body-" .. token,
    {
      ...
      animation_speed = 0.5,
      scale = 0.5,
      tint = green_beam_tint,
      blend_mode = green_beam_blend_mode
    }),
...
local function green_tesla_chain_sprite(token)
  return
  {
...
local function green_tesla_ground_lights()
  return
  {
    head =
    {
...
local function green_tesla_beam_graphics()
  local graphics_set =
  {
  ...
  graphics_set.beam =
  {
    ...
    body =
    {
      {layers = green_tesla_body_sprite('1')},
      {layers = green_tesla_body_sprite('2')},
      {layers = green_tesla_body_sprite('3')},
      {layers = green_tesla_body_sprite('4')},
      {layers = green_tesla_body_sprite('5')},
      {layers = green_tesla_body_sprite('6')},
    }
  }

  graphics_set.ground = green_tesla_ground_lights()

  return graphics_set
end

local function green_tesla_chain_graphics()
  local graphics_set =
  {
    desired_segment_length = 1,
    randomize_animation_per_segment = true
  ...
  graphics_set.beam =
  {
    ...
    head = {layers = green_tesla_chain_sprite('1')},
    tail = {layers = green_tesla_chain_sprite('6')},

    body =
    {
      {layers = green_tesla_chain_sprite('1')},
      {layers = green_tesla_chain_sprite('2')},
      {layers = green_tesla_chain_sprite('3')},
      {layers = green_tesla_chain_sprite('4')},
      {layers = green_tesla_chain_sprite('5')},
      {layers = green_tesla_chain_sprite('6')},
    }
  }
...
local greenTeslaBeamStart =
{
  type = "beam",
  name = "green-tesla-beam-start",
  flags = {"not-on-map"},
  hidden = true,
  width = 0.5,
  damage_interval = 20,
  ...
  action =
  {
    ...
    action_delivery =
    {
      ...
      target_effects =
      {
        {
          type = "damage",
          damage = { amount = 70, type = "electric" }
        },
        {
          type = "push-back",
          distance = 0.5
  ...
  graphics_set = green_tesla_beam_graphics(),
  working_sound =
  {
...
local greenTeslaBeamBounce =
{
  type = "beam",
  name = "green-tesla-beam-bounce",
  flags = {"not-on-map"},
  hidden = true,
  width = 0.5,
  damage_interval = 20,
  ...
  graphics_set = green_tesla_chain_graphics(),
  working_sound =
  {
...
local greenTeslaChain =
{
  type = "chain-active-trigger",
  name = "tier-two-tesla-chain",
  max_jumps = 3,
